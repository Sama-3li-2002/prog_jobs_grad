...
class ShowMessagesProg extends StatefulWidget {
  static const String id = "show_messages_prog";

  @override
  State<ShowMessagesProg> createState() => _ShowMessagesProgState();
}

class _ShowMessagesProgState extends State<ShowMessagesProg> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        StreamBuilder<List<DocumentSnapshot<Map<String, dynamic>>>>(
          stream: FirebaseFireStoreHelper.fireStoreHelper.getAllMessagesFromAllCompaniesStream(
