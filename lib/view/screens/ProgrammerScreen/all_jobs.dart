                                                                ...
                                                                children: [
                                                                  ...
                                                                  TextStyleWidget(
                                                                      allJobsList.isNotEmpty
                                                                          ? allJobsList[index].company_name ??
                                                                              ""
                                                                          : "No Company Name",
                                                                      Colors
                                                                          .black,
                                                          ...
                                                          Row(
                                                            children: [
                                                              ...
                                                              IconButton(
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  bool isJobFavorited = await isFav(allJobsList
                                                                      .elementAt(
                                                                          index)
                                                                      .job_id!);
                          ...
                          if (_searchController.text.isNotEmpty &&
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                late String formattedTime;
                                String timeString =
                                    _filteredJobs[index].current_time ?? "";
                                try {
                                  formattedTime = DateFormat('hh:mm a').format(
                                      DateFormat('hh:mm:ss a')
                                          .parse(timeString));
                                                          ...
                                                          Row(
                                                            children: [
                                                              ...
                                                              IconButton(
                                                                ...
                                                                onPressed:
                                                                    () async {
                                                                  bool isJobFavorited = await isFav(_filteredJobs
                                                                      .elementAt(
                                                                          index)
                                                                      .job_id!);
