  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<ArchiveProvider>(
        builder: (context, archiveProvider, _) => archiveProvider
                .archiveList.isEmpty
            ? Center(child: Text("No available Archive jobs"))
                          ...
                          onTap: () {
                            Navigator.of(context)
                              ...
                              return JobsCompanyDetailsScreen(items: [
                                archiveProvider.archiveList.elementAt(index),
                              ]);
                            }));
                          },
                          child: Container(
