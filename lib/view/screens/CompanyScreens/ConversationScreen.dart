...
class ConversationScreen extends StatefulWidget {
  ...
  ConversationScreen( this.companyUsername,{required this.progUsername});
        ...
        body:Column(
          children: [
            Container(
              ...
              //     image: AssetImage("assets/images/chatBackground.jpg"), // استبدل بمسار الصورة الخاص بك
              //     fit: BoxFit.cover,
              //   ),
              // ),
              child: Column(
                        ...
                        child: Expanded(
                          child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final messages = messagesDocs.map((doc) => Message.fromMap(doc.data())).toList();
                              ...
                              return ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  final isMe = widget.programmerIdLogin == FirebaseAuthController.fireAuthHelper.userId();
                                  return Padding(
                                    padding: EdgeInsetsDirectional.only(
                                      top: SizeConfig.scaleHeight(10),
                                      end: isMe ? SizeConfig.scaleWidth(10) : SizeConfig.scaleWidth(220),
                                      start: isMe ? SizeConfig.scaleWidth(220) : SizeConfig.scaleWidth(10),
                                    ),
                                    child: Container(
                                      decoration: BoxDecoration(
                                        color: isMe ? Color.fromRGBO(76, 81, 117, 0.3) : Colors.grey.shade200,
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            SizedBox(height: 5,),
                                            Text(content, style: TextStyle(color: Colors.black, fontSize: 11, fontWeight: FontWeight.w500)),
                                          ],
                                        ),
                                      ),
                                    ),
                          ...
                          child: IconButton(
                            ...
                            onPressed: ()async {
                              if (messageContent!.isNotEmpty ) {
                                await storeMessages(ConversationScreen.companyId);
