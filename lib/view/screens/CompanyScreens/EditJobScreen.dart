...
class _EditJobScreenState extends State<EditJobScreen> {
  ...
  void initState() {
    ...
    _requried_skills_three = TextEditingController(
        text: widget.jobInfo.first.required_skills_three);
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: TextFieldWidget.textfieldCon(controller: _requried_skills_one,
                            ...
                            Padding(
                              ...
                              child: TextFieldWidget.textfieldCon(controller:_requried_skills_two,hint_Text: "add the skill",),
                            ),
                            Container(
                              width: double.infinity
                              ,height: 1.5,
                            ...
                            Padding(
                              ...
                              child: TextFieldWidget.textfieldCon(controller: _requried_skills_three,hint_Text: "add the skill",),
                            ),
                            Container(
                              width: double.infinity
                              ,height: 1.5,
                            ...
                            Padding(
                              ...
                              child:TextFieldWidget.textfieldCon(controller: _requried_skills_four
                                ,hint_Text: "add the skill",),
                            ),
                          ],
                        ),
  ...
  Future update() async {
    try{
      await FirebaseFireStoreHelper.instance.updateJobsDetails(getJobInfo(), widget.jobInfo[0].job_id!);
    }catch (e) {
